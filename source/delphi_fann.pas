...
const
  DLL_FILE = 'fannfixed.dll';
{$ELSEIF Defined(DOUBLEFANN)}

const
  DLL_FILE = 'fanndouble.dll';
{$ELSE}
...
function fann_mult(x, y: fann_type): fann_type; inline;
// #define fann_div(x,y) (((x) << decimal_point)/y)
function fann_div(x, y: fann_type): fann_type; inline;
// #define fann_random_weight() (fann_type)(fann_rand(0,multiplier/10))
function fann_random_weight(): fann_type; inline;
// #define fann_random_bias_weight() (fann_type)(fann_rand((0-multiplier)/10,multiplier/10))
function fann_random_bias_weight(): fann_type; inline;
...
function fann_get_errstr(errdat: pfann_error): PFANNChar; stdcall;
...
function fann_create_from_file(const configuration_file: PFANNChar): pfann; stdcall;
...
procedure fann_save(ann: pfann; const configuration_file: PFANNChar); stdcall;
...
procedure fann_set_cascade_weight_multiplier(ann: pfann; cascade_weight_multiplier: fann_type); stdcall;
...
procedure fann_set_cascade_candidate_limit(ann: pfann; cascade_candidate_limit: fann_type); stdcall;
...
function fann_get_cascade_min_out_epochs(ann: pfann): Cardinal; stdcall;
...
function fann_get_cascade_max_cand_epochs(ann: pfann): Cardinal; stdcall;
...
function fann_get_cascade_min_cand_epochs(ann: pfann): Cardinal; stdcall;
...
function fann_get_cascade_num_candidates(ann: pfann): Cardinal; stdcall;
...
function fann_create_shortcut(num_layers: Cardinal): pfann; cdecl; varargs;
...
function fann_copy(ann: pfann): pfann; stdcall;
...
procedure fann_init_weights(ann: pfann; train_data: pfann_train_data); stdcall;
...
function fann_get_connection_rate(ann: pfann): Float; stdcall;
...
function fann_get_MSE(ann: pfann): Float; stdcall;
...
function fann_train_epoch(ann: pfann; Data: pfann_train_data): Float; stdcall;
{$ENDIF}	(* NOT FIXEDFANN *)
...
function fann_test_data(ann: pfann; Data: pfann_train_data): Float; stdcall;
...
function fann_set_scaling_params(ann: pfann; const Data: pfann_train_data; new_input_min: Float; new_input_max: Float;
  new_output_min: Float; new_output_max: Float): integer; stdcall;
...
function fann_num_input_train_data(Data: pfann_train_data): Cardinal; stdcall;
...
function fann_num_output_train_data(Data: pfann_train_data): Cardinal; stdcall;
...
function fann_get_learning_rate(ann: pfann): Float; stdcall;
...
procedure fann_set_learning_rate(ann: pfann; learning_rate: Float); stdcall;
...
function fann_get_learning_momentum(ann: pfann): Float; stdcall;
...
// fann_type steepness,
// int layer);
procedure fann_set_activation_steepness_layer(ann: pfann; steepness: fann_type; layer: integer); stdcall;
...
function fann_get_bit_fail_limit(ann: pfann): fann_type; stdcall;
...
procedure fann_set_bit_fail_limit(ann: pfann; bit_fail_limit: fann_type); stdcall;
...
procedure fann_set_callback(ann: pfann; callback: Tfann_callback_type); stdcall;
...
function fann_get_quickprop_decay(ann: pfann): Float; stdcall;
...
procedure fann_set_quickprop_decay(ann: pfann; quickprop_decay: Float); stdcall;
...
function fann_get_quickprop_mu(ann: pfann): Float; stdcall;
...
procedure fann_set_quickprop_mu(ann: pfann; Mu: Float); stdcall;
...
function fann_get_rprop_increase_factor(ann: pfann): Float; stdcall;
...
function fann_get_rprop_decrease_factor(ann: pfann): Float; stdcall;
...
function fann_get_rprop_delta_min(ann: pfann): Float; stdcall;
...
procedure fann_set_rprop_delta_min(ann: pfann; rprop_delta_min: Float); stdcall;
...
function fann_get_rprop_delta_max(ann: pfann): Float; stdcall;
...
procedure fann_set_rprop_delta_max(ann: pfann; rprop_delta_max: Float); stdcall;
...
function fann_get_rprop_delta_zero(ann: pfann): Float; stdcall;
...
function fann_get_sarprop_step_error_shift(ann: pfann): Float; stdcall;
...
function fann_get_sarprop_temperature(ann: pfann): Float; stdcall;
...
function fann_get_cascade_output_change_fraction; external DLL_FILE name '_fann_get_cascade_output_change_fraction@4';
procedure fann_set_cascade_output_change_fraction; external DLL_FILE name '_fann_set_cascade_output_change_fraction@8';
function fann_get_cascade_output_stagnation_epochs; external DLL_FILE name '_fann_get_cascade_output_stagnation_epochs@4';
procedure fann_set_cascade_output_stagnation_epochs; external DLL_FILE name '_fann_set_cascade_output_stagnation_epochs@8';
function fann_get_cascade_candidate_change_fraction; external DLL_FILE name '_fann_get_cascade_candidate_change_fraction@4';
procedure fann_set_cascade_candidate_change_fraction; external DLL_FILE name '_fann_set_cascade_candidate_change_fraction@8';
function fann_get_cascade_candidate_stagnation_epochs; external DLL_FILE name '_fann_get_cascade_candidate_stagnation_epochs@4';
procedure fann_set_cascade_candidate_stagnation_epochs; external DLL_FILE name '_fann_set_cascade_candidate_stagnation_epochs@8';
function fann_get_cascade_weight_multiplier; external DLL_FILE name '_fann_get_cascade_weight_multiplier@4';
procedure fann_set_cascade_weight_multiplier; external DLL_FILE name '_fann_set_cascade_weight_multiplier@8';
function fann_get_cascade_candidate_limit; external DLL_FILE name '_fann_get_cascade_candidate_limit@4';
procedure fann_set_cascade_candidate_limit; external DLL_FILE name '_fann_set_cascade_candidate_limit@8';
function fann_get_cascade_max_out_epochs; external DLL_FILE name '_fann_get_cascade_max_out_epochs@4';
procedure fann_set_cascade_max_out_epochs; external DLL_FILE name '_fann_set_cascade_max_out_epochs@8';
function fann_get_cascade_min_out_epochs; external DLL_FILE name '_fann_get_cascade_min_out_epochs@4';
procedure fann_set_cascade_min_out_epochs; external DLL_FILE name '_fann_set_cascade_min_out_epochs@8';
function fann_get_cascade_max_cand_epochs; external DLL_FILE name '_fann_get_cascade_max_cand_epochs@4';
procedure fann_set_cascade_max_cand_epochs; external DLL_FILE name '_fann_set_cascade_max_cand_epochs@8';
function fann_get_cascade_min_cand_epochs; external DLL_FILE name '_fann_get_cascade_min_cand_epochs@4';
procedure fann_set_cascade_min_cand_epochs; external DLL_FILE name '_fann_set_cascade_min_cand_epochs@8';
function fann_get_cascade_num_candidates; external DLL_FILE name '_fann_get_cascade_num_candidates@4';
function fann_get_cascade_activation_functions_count; external DLL_FILE name '_fann_get_cascade_activation_functions_count@4';
function fann_get_cascade_activation_functions; external DLL_FILE name '_fann_get_cascade_activation_functions@4';
procedure fann_set_cascade_activation_functions; external DLL_FILE name '_fann_set_cascade_activation_functions@12';
function fann_get_cascade_activation_steepnesses_count; external DLL_FILE name '_fann_get_cascade_activation_steepnesses_count@4';
function fann_get_cascade_activation_steepnesses; external DLL_FILE name '_fann_get_cascade_activation_steepnesses@4';
procedure fann_set_cascade_activation_steepnesses; external DLL_FILE name '_fann_set_cascade_activation_steepnesses@12';
function fann_get_cascade_num_candidate_groups; external DLL_FILE name '_fann_get_cascade_num_candidate_groups@4';
procedure fann_set_cascade_num_candidate_groups; external DLL_FILE name '_fann_set_cascade_num_candidate_groups@8';

function fann_create_standard; external DLL_FILE name 'fann_create_standard';
function fann_create_standard_array; external DLL_FILE name '_fann_create_standard_array@8';
function fann_create_sparse; external DLL_FILE name 'fann_create_sparse';
function fann_create_sparse_array; external DLL_FILE name '_fann_create_sparse_array@12';
function fann_create_shortcut; external DLL_FILE name 'fann_create_shortcut';
function fann_create_shortcut_array; external DLL_FILE name '_fann_create_shortcut_array@8';
procedure fann_destroy; external DLL_FILE name '_fann_destroy@4';
function fann_copy; external DLL_FILE name '_fann_copy@4';
...
function fann_get_network_type; external DLL_FILE name '_fann_get_network_type@4';
function fann_get_connection_rate; external DLL_FILE name '_fann_get_connection_rate@4';
function fann_get_num_layers; external DLL_FILE name '_fann_get_num_layers@4';
procedure fann_get_layer_array; external DLL_FILE name '_fann_get_layer_array@8';
procedure fann_get_bias_array; external DLL_FILE name '_fann_get_bias_array@8';
procedure fann_get_connection_array; external DLL_FILE name '_fann_get_connection_array@8';
procedure fann_set_weight_array; external DLL_FILE name '_fann_set_weight_array@12';
procedure fann_set_weight; external DLL_FILE name '_fann_set_weight@16';
procedure fann_set_user_data; external DLL_FILE name '_fann_set_user_data@8';
function fann_get_user_data; external DLL_FILE name '_fann_get_user_data@4';
{$IFDEF FIXEDFANN}
function fann_get_decimal_point; external DLL_FILE name '_fann_get_decimal_point@4';
function fann_get_multiplier; external DLL_FILE name '_fann_get_multiplier@4';
{$ENDIF}
...
function fann_get_bit_fail; external DLL_FILE name '_fann_get_bit_fail@4';
...
function fann_create_train; external DLL_FILE name '_fann_create_train@12';
function fann_create_train_from_callback; external DLL_FILE name '_fann_create_train_from_callback@16';
...
procedure fann_scale_train; external DLL_FILE name '_fann_scale_train_data@12';
...
procedure fann_scale_input; external DLL_FILE name '_fann_scale_input_train_data@12';
procedure fann_scale_output; external DLL_FILE name '_fann_scale_output_train_data@12';
procedure fann_descale_input; external DLL_FILE;
procedure fann_descale_output; external DLL_FILE;
procedure fann_scale_input_train_data; external DLL_FILE name '_fann_scale_input_train_data@12';
procedure fann_scale_output_train_data; external DLL_FILE name '_fann_scale_output_train_data@12';
procedure fann_scale_train_data; external DLL_FILE name '_fann_scale_train_data@12';
...
function fann_subset_train_data; external DLL_FILE name '_fann_subset_train_data@12';
function fann_length_train_data; external DLL_FILE name '_fann_length_train_data@4';
function fann_num_input_train_data; external DLL_FILE name '_fann_num_input_train_data@4';
function fann_num_output_train_data; external DLL_FILE name '_fann_num_output_train_data@4';
function fann_save_train; external DLL_FILE name '_fann_save_train@8';
function fann_save_train_to_fixed; external DLL_FILE name '_fann_save_train_to_fixed@12';
...
function fann_get_learning_momentum; external DLL_FILE name '_fann_get_learning_momentum@4';
procedure fann_set_learning_momentum; external DLL_FILE name '_fann_set_learning_momentum@8';
function fann_get_activation_function; external DLL_FILE name '_fann_get_activation_function@12';
procedure fann_set_activation_function; external DLL_FILE name '_fann_set_activation_function@16';
procedure fann_set_activation_function_layer; external DLL_FILE name '_fann_set_activation_function_layer@12';
...
function fann_get_activation_steepness; external DLL_FILE name '_fann_get_activation_steepness@12';
procedure fann_set_activation_steepness; external DLL_FILE name '_fann_set_activation_steepness@16';
procedure fann_set_activation_steepness_layer; external DLL_FILE name '_fann_set_activation_steepness_layer@12';
...
function fann_get_train_stop_function; external DLL_FILE name '_fann_get_train_stop_function@4';
procedure fann_set_train_stop_function; external DLL_FILE name '_fann_set_train_stop_function@8';
function fann_get_bit_fail_limit; external DLL_FILE name '_fann_get_bit_fail_limit@4';
procedure fann_set_bit_fail_limit; external DLL_FILE name '_fann_set_bit_fail_limit@8';
procedure fann_set_callback; external DLL_FILE name '_fann_set_callback@8';
...
function fann_get_rprop_delta_zero; external DLL_FILE name '_fann_get_rprop_delta_zero@4';
procedure fann_set_rprop_delta_zero; external DLL_FILE name '_fann_set_rprop_delta_zero@8';
function fann_get_sarprop_weight_decay_shift; external DLL_FILE name '_fann_get_sarprop_weight_decay_shift@4';
procedure fann_set_sarprop_weight_decay_shift; external DLL_FILE name '_fann_set_sarprop_weight_decay_shift@8';
function fann_get_sarprop_step_error_threshold_factor; external DLL_FILE name '_fann_get_sarprop_step_error_threshold_factor@4';
procedure fann_set_sarprop_step_error_threshold_factor; external DLL_FILE name '_fann_set_sarprop_step_error_threshold_factor@8';
function fann_get_sarprop_step_error_shift; external DLL_FILE name '_fann_get_sarprop_step_error_shift@4';
procedure fann_set_sarprop_step_error_shift; external DLL_FILE name '_fann_set_sarprop_step_error_shift@8';
function fann_get_sarprop_temperature; external DLL_FILE name '_fann_get_sarprop_temperature@4';
procedure fann_set_sarprop_temperature; external DLL_FILE name '_fann_set_sarprop_temperature@8';
{$ELSEIF Defined(DOUBLEFANN)}
procedure fann_set_error_log; external DLL_FILE name '_fann_set_error_log@8';
function fann_get_errno; external DLL_FILE name '_fann_get_errno@4';
procedure fann_reset_errno; external DLL_FILE name '_fann_reset_errno@4';
...
procedure fann_cascadetrain_on_data; external DLL_FILE name '_fann_cascadetrain_on_data@20';
procedure fann_cascadetrain_on_file; external DLL_FILE name '_fann_cascadetrain_on_file@20';
function fann_get_cascade_output_change_fraction; external DLL_FILE name '_fann_get_cascade_output_change_fraction@4';
procedure fann_set_cascade_output_change_fraction; external DLL_FILE name '_fann_set_cascade_output_change_fraction@8';
function fann_get_cascade_output_stagnation_epochs; external DLL_FILE name '_fann_get_cascade_output_stagnation_epochs@4';
procedure fann_set_cascade_output_stagnation_epochs; external DLL_FILE name '_fann_set_cascade_output_stagnation_epochs@8';
...
procedure fann_set_cascade_candidate_stagnation_epochs; external DLL_FILE name '_fann_set_cascade_candidate_stagnation_epochs@8';
function fann_get_cascade_weight_multiplier; external DLL_FILE name '_fann_get_cascade_weight_multiplier@4';
procedure fann_set_cascade_weight_multiplier; external DLL_FILE name '_fann_set_cascade_weight_multiplier@12';
function fann_get_cascade_candidate_limit; external DLL_FILE name '_fann_get_cascade_candidate_limit@4';
procedure fann_set_cascade_candidate_limit; external DLL_FILE name '_fann_set_cascade_candidate_limit@12';
function fann_get_cascade_max_out_epochs; external DLL_FILE name '_fann_get_cascade_max_out_epochs@4';
procedure fann_set_cascade_max_out_epochs; external DLL_FILE name '_fann_set_cascade_max_out_epochs@8';
function fann_get_cascade_min_out_epochs; external DLL_FILE name '_fann_get_cascade_min_out_epochs@4';
procedure fann_set_cascade_min_out_epochs; external DLL_FILE name '_fann_set_cascade_min_out_epochs@8';
...
function fann_copy; external DLL_FILE name '_fann_copy@4';
function fann_run; external DLL_FILE name '_fann_run@8';
procedure fann_randomize_weights; external DLL_FILE name '_fann_randomize_weights@20';
procedure fann_init_weights; external DLL_FILE name '_fann_init_weights@8';
procedure fann_print_connections; external DLL_FILE name '_fann_print_connections@4';
procedure fann_print_parameters; external DLL_FILE name '_fann_print_parameters@4';
function fann_get_num_input; external DLL_FILE name '_fann_get_num_input@4';
...
procedure fann_get_connection_array; external DLL_FILE name '_fann_get_connection_array@8';
procedure fann_set_weight_array; external DLL_FILE name '_fann_set_weight_array@12';
procedure fann_set_weight; external DLL_FILE name '_fann_set_weight@20';
procedure fann_set_user_data; external DLL_FILE name '_fann_set_user_data@8';
function fann_get_user_data; external DLL_FILE name '_fann_get_user_data@4';
{$IFDEF FIXEDFANN}
...
procedure fann_destroy_train; external DLL_FILE name '_fann_destroy_train@4';
procedure fann_shuffle_train_data; external DLL_FILE name '_fann_shuffle_train_data@4';
procedure fann_scale_train; external DLL_FILE name '_fann_scale_train@8';
procedure fann_descale_train; external DLL_FILE name '_fann_descale_train@8';
function fann_set_input_scaling_params; external DLL_FILE name '_fann_set_input_scaling_params@16';
function fann_set_output_scaling_params; external DLL_FILE name '_fann_set_output_scaling_params@16';
function fann_set_scaling_params; external DLL_FILE name '_fann_set_scaling_params@24';
function fann_clear_scaling_params; external DLL_FILE name '_fann_clear_scaling_params@4';
procedure fann_scale_input; external DLL_FILE name '_fann_scale_input@8';
procedure fann_scale_output; external DLL_FILE name '_fann_scale_output@8';
procedure fann_descale_input; external DLL_FILE name '_fann_descale_input@8';
procedure fann_descale_output; external DLL_FILE name '_fann_descale_output@8';
procedure fann_scale_input_train_data; external DLL_FILE name '_fann_scale_input_train_data@20';
procedure fann_scale_output_train_data; external DLL_FILE name '_fann_scale_output_train_data@20';
procedure fann_scale_train_data; external DLL_FILE name '_fann_scale_train_data@20';
function fann_merge_train_data; external DLL_FILE name '_fann_merge_train_data@8';
function fann_duplicate_train_data; external DLL_FILE name '_fann_duplicate_train_data@4';
function fann_subset_train_data; external DLL_FILE name '_fann_subset_train_data@12';
function fann_length_train_data; external DLL_FILE name '_fann_length_train_data@4';
...
procedure fann_set_activation_function_output; external DLL_FILE name '_fann_set_activation_function_output@8';
function fann_get_activation_steepness; external DLL_FILE name '_fann_get_activation_steepness@12';
procedure fann_set_activation_steepness; external DLL_FILE name '_fann_set_activation_steepness@20';
procedure fann_set_activation_steepness_layer; external DLL_FILE name '_fann_set_activation_steepness_layer@16';
procedure fann_set_activation_steepness_hidden; external DLL_FILE name '_fann_set_activation_steepness_hidden@12';
procedure fann_set_activation_steepness_output; external DLL_FILE name '_fann_set_activation_steepness_output@12';
function fann_get_train_error_function; external DLL_FILE name '_fann_get_train_error_function@4';
procedure fann_set_train_error_function; external DLL_FILE name '_fann_set_train_error_function@8';
function fann_get_train_stop_function; external DLL_FILE name '_fann_get_train_stop_function@4';
procedure fann_set_train_stop_function; external DLL_FILE name '_fann_set_train_stop_function@8';
function fann_get_bit_fail_limit; external DLL_FILE name '_fann_get_bit_fail_limit@4';
procedure fann_set_bit_fail_limit; external DLL_FILE name '_fann_set_bit_fail_limit@12';
procedure fann_set_callback; external DLL_FILE name '_fann_set_callback@8';
function fann_get_quickprop_decay; external DLL_FILE name '_fann_get_quickprop_decay@4';
procedure fann_set_quickprop_decay; external DLL_FILE name '_fann_set_quickprop_decay@8';
function fann_get_quickprop_mu; external DLL_FILE name '_fann_get_quickprop_mu@4';
